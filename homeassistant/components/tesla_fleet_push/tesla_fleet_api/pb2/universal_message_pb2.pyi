...
class Destination(_message.Message):
    ...
    def __init__(
        self, domain: Domain | str | None = ..., routing_address: bytes | None = ...
    ) -> None: ...
...
class MessageStatus(_message.Message):
    ...
    def __init__(
        self,
        operation_status: OperationStatus_E | str | None = ...,
        signed_message_fault: MessageFault_E | str | None = ...,
    ) -> None: ...
...
class SessionInfoRequest(_message.Message):
    ...
    def __init__(
        self, public_key: bytes | None = ..., challenge: bytes | None = ...
    ) -> None: ...
...
class RoutableMessage(_message.Message):
    ...
    def __init__(
        self,
        to_destination: Destination | _Mapping | None = ...,
        from_destination: Destination | _Mapping | None = ...,
        protobuf_message_as_bytes: bytes | None = ...,
        session_info_request: SessionInfoRequest | _Mapping | None = ...,
        session_info: bytes | None = ...,
        signature_data: _signatures_pb2.SignatureData | _Mapping | None = ...,
        signedMessageStatus: MessageStatus | _Mapping | None = ...,
        request_uuid: bytes | None = ...,
        uuid: bytes | None = ...,
        flags: int | None = ...,
    ) -> None: ...
