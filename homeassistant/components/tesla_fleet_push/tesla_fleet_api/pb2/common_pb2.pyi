...
class ChargePortLatchState(_message.Message):
    ...
    def __init__(
        self,
        SNA: Void | _Mapping | None = ...,
        Disengaged: Void | _Mapping | None = ...,
        Engaged: Void | _Mapping | None = ...,
        Blocking: Void | _Mapping | None = ...,
    ) -> None: ...
...
class PreconditioningTimes(_message.Message):
    ...
    def __init__(
        self,
        all_week: Void | _Mapping | None = ...,
        weekdays: Void | _Mapping | None = ...,
    ) -> None: ...
